...
export function HabitRow({ habit, showArchived }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(motion.div, { layout: true, className: "flex items-center gap-4 rounded-xl border border-border bg-white px-4 py-3 dark:bg-neutral-900 dark:border-neutral-800", initial: { opacity: 0, y: 6 }, animate: { opacity: 1, y: 0 }, children: [_jsx("div", { className: "flex h-10 w-10 shrink-0 items-center justify-center rounded-lg text-xl", style: { backgroundColor: rgbaFromHex(habit.color, 0.12) }, children: habit.icon }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsxs("div", { className: "flex items-center gap-1.5 min-w-0", children: [_jsx("button", { onClick: () => navigate(`/habits/${habit.id}`), className: "truncate text-sm font-medium text-ink hover:underline dark:text-neutral-100 text-left", children: habit.name }), habit.habitType === "negative" && (_jsx("span", { className: "shrink-0 text-[9px] font-semibold px-1.5 py-0.5 rounded-full bg-rose-100 text-rose-500 dark:bg-rose-900/30 dark:text-rose-400", children: "break" }))] }), _jsx("p", { className: "text-xs text-muted", children: frequencyLabel(habit) })] }), _jsxs("div", { className: "hidden sm:flex items-center gap-6 text-center", children: [_jsxs("div", { children: [_jsxs("p", { className: "text-sm font-semibold text-ink dark:text-white", children: [habit.habitType === "negative" ? "✨" : "🔥", habit.currentStreak] }), _jsx("p", { className: "text-[10px] text-muted", children: habit.habitType === "negative" ? "clean" : "streak" })] }), _jsxs("div", { children: [_jsx("p", { className: "text-sm font-semibold text-ink dark:text-white", children: habit.longestStreak }), _jsx("p", { className: "text-[10px] text-muted", children: "best" })] }), _jsx("div", { children: _jsxs(Badge, { style: {
