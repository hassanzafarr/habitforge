...
export function HabitDetailPage() {
    ...
    return (_jsxs("div", { className: "mx-auto max-w-4xl px-4 py-8 space-y-6", children: [_jsxs("button", { onClick: () => navigate(-1), className: "flex items-center gap-1 text-sm text-muted hover:text-ink dark:hover:text-white transition-colors", children: [_jsx(ArrowLeft, { size: 14 }), " Back"] }), _jsxs("div", { className: "rounded-2xl p-6 flex items-start gap-4", style: { backgroundColor: rgbaFromHex(habit.color, 0.08) }, children: [_jsx("div", { className: "flex h-16 w-16 items-center justify-center rounded-2xl text-3xl shrink-0", style: { backgroundColor: rgbaFromHex(habit.color, 0.18) }, children: habit.icon }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("h1", { className: "text-xl font-bold tracking-tight text-ink dark:text-white", children: habit.name }), habit.description && (_jsx("p", { className: "text-sm text-muted mt-0.5", children: habit.description })), isArchived && (_jsx("span", { className: "inline-block mt-1 text-xs text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full dark:bg-amber-900/20", children: "Archived" }))] }), _jsxs("div", { className: "flex gap-2", children: [!isArchived && (_jsxs(Button, { variant: "secondary", size: "sm", onClick: () => setEditing(true), children: [_jsx(Pencil, { size: 13 }), " Edit"] })), isArchived ? (_jsxs(Button, { variant: "secondary", size: "sm", onClick: () => restoreMut.mutate(), disabled: restoreMut.isPending, children: [_jsx(RotateCcw, { size: 13 }), " Restore"] })) : (_jsxs(Button, { variant: "secondary", size: "sm", onClick: () => archiveMut.mutate(), disabled: archiveMut.isPending, children: [_jsx(Archive, { size: 13 }), " Archive"] }))] })] }), _jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3", children: [
